...
public class ControlPanelTeacherDoConroller
{
    @FXML
    ...
    {
        imageView1.setImage(new Image("file:resources/images/iconRecoveryParol.png"));
        imageView2.setImage(new Image("file:resources/images/iconSpravka.png"));
        imageView3.setImage(new Image("file:resources/images/iconV.png"));
    }
    ...
    private void buttonselection() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(MainDiary.class.getResource("ControlPanelTeacher/ControlPanelTeacherPosle.fxml"));
        ...
        ControlPanelTeacherPosleController controller = fxmlLoader.getController();
